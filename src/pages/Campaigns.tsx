	...
	const activeCampaigns = [
		{
			...
			description:
				"Educating students about textile waste and sustainability through interactive workshops and competitions.",
			image:
				"https://images.pexels.com/photos/8926552/pexels-photo-8926552.jpeg?auto=compress&cs=tinysrgb&w=800",
		...
		},
		{
			...
			description:
				"Neighborhood textile collection events to gather materials for recycling while building community awareness.",
			image:
		...
		},
		{
			...
			description:
				"Partnering with fashion designers to create awareness about sustainable fashion and textile recycling.",
			image:
	...
	const upcomingCampaigns = [
		{
			...
			description:
				"Student competition to develop innovative textile recycling solutions and business models.",
			image:
		...
		},
		{
			...
			description:
				"National campaign to raise awareness about textile waste impact and promote recycling solutions.",
			image:
				"https://images.pexels.com/photos/6647022/pexels-photo-6647022.jpeg?auto=compress&cs=tinysrgb&w=800",
	...
	const completedCampaigns = [
		{
			...
			description:
				"Helped 20 textile factories implement zero-waste policies and recycling programs.",
			image:
				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<motion.div
						...
						<p className='text-xl md:text-2xl text-emerald-purple-100 max-w-3xl mx-auto'>
							Join our community-driven initiatives to create awareness, collect
							textile waste, and build a more sustainable Egypt.
						</p>
					</motion.div>
				</div>
			</section>
						...
						{campaignStats.map((stat, index) => (
							<motion.div
								...
								<div className='inline-flex items-center justify-center w-16 h-16 bg-emerald-purple-100 rounded-full mb-4'>
									<stat.icon className='h-8 w-8 text-emerald-purple-600' />
								</div>
				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<motion.div
						...
						<p className='text-xl text-gray-600 max-w-3xl mx-auto'>
							Current initiatives making a real impact across Egypt. Join us and
								...
								<div className='p-6'>
									...
									<div className='space-y-3 mb-4'>
										<div className='flex items-center text-sm text-gray-600'>
											<Calendar className='h-4 w-4 mr-2 text-emerald-purple-600' />
											<span>
										...
										<div className='flex items-center text-sm text-gray-600'>
											<MapPin className='h-4 w-4 mr-2 text-emerald-purple-600' />
			...
			<section className='py-20 bg-white'>
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<motion.div
						...
						<p className='text-xl text-gray-600 max-w-3xl mx-auto'>
							Get ready for these exciting initiatives launching soon. Sign up
							to be notified!
						</p>
					</motion.div>
			...
			<section className='py-20 bg-gray-50'>
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<motion.div
						...
						<p className='text-xl text-gray-600 max-w-3xl mx-auto'>
							Celebrating the impact of our completed campaigns and the
							communities that made them successful.
						</p>
					</motion.div>
				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
					<motion.div
						...
						<p className='text-xl text-green-100 mb-8 max-w-3xl mx-auto'>
							Have an idea for a sustainability campaign? We'd love to support
							your initiative and help you make a difference in your community.
						</p>
