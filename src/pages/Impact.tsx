...
import { TreePine, Droplets, Factory, Users, Globe, Recycle, Award, TrendingUp } from 'lucide-react';
  ...
  const milestones = [
    {
      ...
      description: 'Weavolution was founded as an Enactus project to tackle Egypt\'s textile waste crisis.',
      icon: Award,
    },
    {
      year: '2023',
      title: 'First Production',
      description: 'Successfully produced our first batch of recycled 3D printing filament.',
      icon: Factory,
    },
    {
      year: '2023',
      title: 'Partnership Growth',
      description: 'Established partnerships with 50+ textile manufacturers across Egypt.',
      icon: Users,
    },
    {
      year: '2024',
      title: 'Scale Up',
      description: 'Expanded operations to process 3 million tons of textile waste annually.',
      icon: TrendingUp,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-green-100 max-w-3xl mx-auto">
              Measuring our positive contribution to Egypt's environment and communities through sustainable textile recycling.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Every piece of textile waste we process creates measurable positive impact on our planet and communities.
            </p>
          </motion.div>
            ...
            {impactStats.map((stat, index) => (
              ...
              >
                <div className="relative">
                  <div className={`inline-flex items-center justify-center w-20 h-20 ${stat.bgColor} rounded-full mb-6 group-hover:scale-110 transition-transform duration-300`}>
            ...
            <div>
              ...
              >
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Our textile recycling process creates significant environmental benefits compared to traditional disposal methods.
                </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From a university project to a leading sustainable manufacturing initiative in Egypt.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-green-100 mb-8 max-w-3xl mx-auto">
              Join us in creating a more sustainable future for Egypt. Every partnership, every purchase, every action counts.
            </p>
